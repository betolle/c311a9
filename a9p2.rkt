#lang racket
;Transform your closure constructor to a define-union, change the match in apply-closure
;to instead use union-case, and ensure that your constructor invocations are preceded with
;clos_, or something other than clos if you use a different name for your union. Make sure
;to remove the backquotes and commas in the patterns in what was your match expression.
