#lang racket
;Replace your higher-order function representation of closures with a tagged-list data structure representation.
;Consider first ensuring that the last two formal parameters to apply-closure (a and k) are the same as the
;formal parameters to the inner function in make-closure.
